...
> If you don't have nodejs and npm installed on your system, I recommend you install them with nvm(node version manager) on your system.
...
> You can run ```npm start``` after step 5 to see the preview in your local host.
